import { View, Text, Pressable, Image, TextInput, Switch, ScrollView, Alert, Platform } from 'react-native'
                ...
                <View className='px-4 pt-4 gap-4'>
                    ...
                    <View className='items-center mb-4'>
                        <View className='relative mb-3'>
                            <Image
                                source={profileImage ? { uri: profileImage } : IMAGES.ProfileAvatar}
                        ...
                        <Text className='font-InterBold text-[19px] text-slate-800'>{formData.name}</Text>
                    ...
                    >
                        ...
                        <View className='gap-4'>
                            ...
                            <View>
                                ...
                                />
                                {errors.name && (
                                    <Text className='font-Inter text-[11px] text-red-500 mt-1.5'>{errors.name}</Text>
                                )}
                            </View>
                            ...
                            <View>
                                ...
                                />
                                {errors.email && (
                                    <Text className='font-Inter text-[11px] text-red-500 mt-1.5'>{errors.email}</Text>
                                )}
                            </View>
                            ...
                            <View>
                                ...
                                />
                                {errors.phone && (
                                    <Text className='font-Inter text-[11px] text-red-500 mt-1.5'>{errors.phone}</Text>
                                )}
                            </View>
                        </View>
                    </View>
                        ...
                        <View className='gap-4'>
                            ...
                            <View>
                                ...
                                {errors.currentPassword && (
                                    <Text className='font-Inter text-[11px] text-red-500 mt-1.5'>{errors.currentPassword}</Text>
                                )}
                            </View>
                            ...
                            <View>
                                ...
                                {errors.newPassword && (
                                    <Text className='font-Inter text-[11px] text-red-500 mt-1.5'>{errors.newPassword}</Text>
                                )}
                            </View>
                            ...
                            <View>
                                ...
                                {errors.confirmPassword && (
                                    <Text className='font-Inter text-[11px] text-red-500 mt-1.5'>{errors.confirmPassword}</Text>
                                )}
                            </View>
                        </View>
                    </View>
                    ...
                    >
                        ...
                        <View>
                            {[
                                ...
                                <Pressable
                                    key={index}
                                    className={`flex-row justify-between items-center py-3.5 ${index < 3 ? 'border-b border-gray-100' : ''
                                        } active:bg-gray-50`}
                                >
